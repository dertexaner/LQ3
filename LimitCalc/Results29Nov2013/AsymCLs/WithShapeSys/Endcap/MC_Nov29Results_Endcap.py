...
#Set MC label
MCtext = TPaveText(0.38,0.55,0.76,0.6,"NDC");
#MCtext = TPaveText(0.6,0.785,0.77,0.89,"NDC");
MCtext.SetFillStyle(0)
MCtext.SetFillColor(0)
MCtext.SetLineColor(0)
MCtext.SetBorderSize(1)
MCtext.AddText("MC Only")
MCtext.SetTextSize(0.037)
MCtext.SetTextFont(42)


#Set Legend
#legend=TLegend(0.5,0.63,0.76,0.87)
legend=TLegend(0.33,0.63,0.76,0.87)
...
legend.SetHeader("Endcap Channel: |#tilde{#eta}|#geq0.9")
legend.AddEntry(ObsLimitHisto,"Observed Limit in MC (19.5/fb)","PL")
...
legend.AddEntry(MeanExpLimitHisto,"Expected Limit in MC","L")
...
can.SaveAs("MyLimitPlotter_"+input1+"_"+input2+"_EndcapWShapeSys.pdf")
