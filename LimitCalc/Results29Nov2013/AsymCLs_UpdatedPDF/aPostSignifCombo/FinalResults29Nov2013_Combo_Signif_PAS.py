...
###legend=TLegend(0.23,0.82,0.87,0.92)
legend=TLegend(0.18,0.82,0.67,0.92)
...
LQ3xsecLine.GetYaxis().SetRangeUser(0,8.9)
...
#Draw Histograms
SetHistoStylePAS(LQ3xsecLine)
LQ3xsecLine.GetXaxis().SetTitleSize(0.052)
LQ3xsecLine.Draw("PAL")
sigma3line.Draw("HIST ][same")
LQ3xsecLine.Draw("PLsame")
#legend.SetHeader("Combination: Barrel & Endcap")
legend.SetHeader("CMS Preliminary, #sqrt{s}=8 TeV")
#legend.SetHeader("Barrel Channel: |#tilde{#eta}|<0.9")
#legend.AddEntry(ObsLimitHisto,"Observed Limit (19.5/fb)","PL")
legend.AddEntry(LQ3xsecLine,"Expected Significance (19.5/fb)","PL")
#legend.AddEntry(LQ3xsecLine,"Expected Signif. (19.5/fb)","PL")
...
#CMStext.Draw();
SetLegendStylePAS(legend)
legend.Draw();
gPad.RedrawAxis();

can.SaveAs("MyLimitPlotter_"+input1+"_"+input2+"_Combo_aPostSignif_PASstyle.pdf")
