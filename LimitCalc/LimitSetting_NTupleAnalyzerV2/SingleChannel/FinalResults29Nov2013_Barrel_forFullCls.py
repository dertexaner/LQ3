...
for ifile in xrange(0,len(InputFileArray)):
    ...
    # ------------------------
print
print "Input Parameters are:  Mass ExpLimit + Upper - Lower  :::  OBSERVED"
for i in xrange(0,len(ExpLimitArray)):
    #print MassArray[i]," ",ExpLimitArray[i]," +",Up1ExpLimitArray[i],"(",Up2ExpLimitArray[i],") -",Down1ExpLimitArray[i],"(",Down2ExpLimitArray[i],")  :::  ",ObsLimitArray[i]
    print MassArray[i],": ",Up2ExpLimitArray[i],"++ ",Up1ExpLimitArray[i],"+ ",ExpLimitArray[i]," -",Down1ExpLimitArray[i]," --",Down2ExpLimitArray[i],"  Obs: ",ObsLimitArray[i]
print
