#!/bin/bash
#analysisClass.C -> ../LAC/analysisClass_DATA_MC_LTEM_FakeMu_OfflineSelectionSkimHistograms_MuTrigger_V3.C
...
-o /afs/cern.ch/work/h/hsaka/private/LQ3/BatchJobs2013/RootNtuple-V00-03-11_FakeMuSkim_MuTrigger_V3_Histograms_V13/ \
-j 50 -q 1nd
