#!/bin/bash
#analysisClass.C -> ../LAC/analysisClass_DATA_MC_LTEM_FakeMu_OfflineSelectionSkimHistograms_MuTrigger_V2.C

./scripts/launchAnalysis_batch.pl \
-i config/inputFolder/inputList_batch_RootNtuple-V00-03-11_QCD.txt \
-c config/cutFiles/cutFile_DATA_MC_OfflineSelectionSkimHistograms_ReducedSkim_FakeStudies_MuTrigger.txt \
-n rootTupleTree/tree \
-o /afs/cern.ch/work/h/hsaka/private/LQ3/BatchJobs2013/RootNtuple-V00-03-11_LTEM_FakeMuSkim_MuTrigger_HistogramsV1/ \
-j 50 -q 1nd
