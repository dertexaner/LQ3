...
-i config/inputFile_analysisClass_DATA_MC_LTEM_MuTauSkim_V2/inputFile_batch_analysisClass_DATA_MC_LTEM_MuTauSkim.txt \
-c config/cutFiles/cutFile_DATA_MC_OfflineSelectionSkimHistograms_Dilepton.txt \
-n rootTupleTree/tree \
-o /afs/cern.ch/work/h/hsaka/private/LQ3/BatchJobs2013/RootNtuple-V00-03-11_LTEM_MuTauSkim_V2_Histograms_V1_Mu40_Control/ \
-j 1 -q 2nd
