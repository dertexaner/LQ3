#!/bin/bash
#analysisClass.C -> ../LAC/analysisClass_DATA_MC_LTEM_MuMuSkim_V2.C
...
-o /afs/cern.ch/work/h/hsaka/private/LQ3/BatchJobs2013/RootNtuple-V00-03-11_LTEM_MuMuSkim_V1/ \
-j 50 -q 1nd
...
#taken out since mumu skim wont help reducing the size much
#./scripts/launchAnalysis_batch.pl \
