...
-i config/inputFile_analysisClass_DATA_MC_LTEM_MuTauSkim_V1/inputFile_batch_analysisClass_DATA_MC_LTEM_MuTauSkim_NODATA.txt \
-c config/cutFiles/cutFile_DATA_MC_OfflineSelectionSkimHistograms_Dilepton.txt \
-n rootTupleTree/tree \
-o /afs/cern.ch/work/h/hsaka/private/LQ3/BatchJobs2013/RootNtuple-V00-03-11_LTEM_MuTauSkim_V1_Histograms_V7_Mu40_Control/ \
-j 1 -q 2nd



#analysisClass.C -> ../LAC/analysisClass_DATA_MC_LTEM_MuTau_OfflineSelectionSkimHistograms.C   < EDIT FOR LQ3 specific gen-reco matching
#analysisClass.h -> ../LAC/analysisClass_LAC.h
