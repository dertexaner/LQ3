...
//#include "LAC/ADDON5_H_LAC.C" //gen-reco matching for Higgs
...
void analysisClass::Loop()
{
   ...
   //////////book histos here
   TH2D* SystematicsTT2Dhisto       = new TH2D("SystematicsTT2Dhisto",       "SystematicsTT2Dhisto",       10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTW12Dhisto     = new TH2D("SystematicsTTW12Dhisto",     "SystematicsTTW12Dhisto",     10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPP2Dhisto     = new TH2D("SystematicsTTPP2Dhisto",     "SystematicsTTPP2Dhisto",     10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPPW12Dhisto   = new TH2D("SystematicsTTPPW12Dhisto",   "SystematicsTTPPW12Dhisto",   10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPPQF2Dhisto   = new TH2D("SystematicsTTPPQF2Dhisto",   "SystematicsTTPPQF2Dhisto",   10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPPQFW12Dhisto = new TH2D("SystematicsTTPPQFW12Dhisto", "SystematicsTTPPQFW12Dhisto", 10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPPQC2Dhisto   = new TH2D("SystematicsTTPPQC2Dhisto",   "SystematicsTTPPQC2Dhisto",   10,0.5,10.5, 14,-0.5,13.5 );
   TH2D* SystematicsTTPPQCW12Dhisto = new TH2D("SystematicsTTPPQCW12Dhisto", "SystematicsTTPPQCW12Dhisto", 10,0.5,10.5, 14,-0.5,13.5 );
   //
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     for(unsigned int iSys=0; iSys<14; iSys++){ //loop over all systematics per event that passes the pre-skim as given above
	 ...
	 w=(double)(w*trigPrescale_);
       ...
       //
       //if( AveAbsEtaV3_>=0.9 ) continue;// AveAbsEtaV3_ BARREL
       if( AveAbsEtaV3_<0.9  ) continue;// AveAbsEtaV3_ ENDCAP
       //
	 ...
	 //iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
	   SystematicsTTPP2Dhisto->Fill( iLQ, iSys, w );
	   SystematicsTTPPW12Dhisto->Fill( iLQ, iSys, 1 );
	   if( isRecoTauChargeFlip_ ){ // if tau charge flip
	     SystematicsTTPPQF2Dhisto->Fill( iLQ, iSys, w );
	     SystematicsTTPPQFW12Dhisto->Fill( iLQ, iSys, 1 );
	   }
	   if( !isRecoTauChargeFlip_ ){//if genuine same-sign
	     SystematicsTTPPQC2Dhisto->Fill( iLQ, iSys, w );
	     SystematicsTTPPQCW12Dhisto->Fill( iLQ, iSys, 1 );
	   }
	 }
       }
       //
