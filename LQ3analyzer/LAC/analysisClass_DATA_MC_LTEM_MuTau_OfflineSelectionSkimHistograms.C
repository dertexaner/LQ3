...
void analysisClass::Loop()
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     TriggerEfficiencyWeights_=IsoMu24e2p1_Eff( 50, MuonEta->at(triggerMuon) );
     ...
     //if( isMuTauDR0p30() && ST()>300 && muRTightCheck(triggerMuon) ) isOfflineDilepton_ = 1;
     ...
     if( ST()>400 && JetCounter()>0 && ltemMuTau.size()==2 ) OfflineCuts_=1; // <<<< CONTROL REGION with no DATA
