...
void analysisClass::Loop()
{
   ...
   TH2D* NFSystematicsTT2Dhisto       = new TH2D("NFSystematicsTT2Dhisto",       "NFSystematicsTT2Dhisto",        1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTW12Dhisto     = new TH2D("NFSystematicsTTW12Dhisto",     "NFSystematicsTTW12Dhisto",      1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPP2Dhisto     = new TH2D("NFSystematicsTTPP2Dhisto",     "NFSystematicsTTPP2Dhisto",      1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPPW12Dhisto   = new TH2D("NFSystematicsTTPPW12Dhisto",   "NFSystematicsTTPPW12Dhisto",    1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPPQF2Dhisto   = new TH2D("NFSystematicsTTPPQF2Dhisto",   "NFSystematicsTTPPQF2Dhisto",    1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPPQFW12Dhisto = new TH2D("NFSystematicsTTPPQFW12Dhisto", "NFSystematicsTTPPQFW12Dhisto",  1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPPQC2Dhisto   = new TH2D("NFSystematicsTTPPQC2Dhisto",   "NFSystematicsTTPPQC2Dhisto",    1,0.5,1.5, 195,-0.5,194.5 );
   TH2D* NFSystematicsTTPPQCW12Dhisto = new TH2D("NFSystematicsTTPPQCW12Dhisto", "NFSystematicsTTPPQCW12Dhisto",  1,0.5,1.5, 195,-0.5,194.5 );
   //
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     for(unsigned int iPdfSys=0; iPdfSys<Nnnpdf; iPdfSys++){ 
       ...
       //weights pileup only! (disabled trigger weights below)
	 ...
	 if( iPdfSys>=Nmstw && iPdfSys<Nnnpdf ) wpdf = PDFNNPDFWeights->at(iPdfSys-Nmstw)/PDFCTEQWeights->at(0);
       ...
       NFSystematicsTT2Dhisto->Fill(   1, iPdfSys, w );
       NFSystematicsTTW12Dhisto->Fill( 1, iPdfSys, 1 );
       //if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       //NFSystematicsTTPP2Dhisto->Fill(  1, iPdfSys, w );
       //NFSystematicsTTPPW12Dhisto->Fill( 1, iPdfSys, 1 );
       //if( isRecoTauChargeFlip_ ){ // if tau charge flip
       //NFSystematicsTTPPQF2Dhisto->Fill(   1, iPdfSys, w );
       //NFSystematicsTTPPQFW12Dhisto->Fill( 1, iPdfSys, 1 );
       //}
       //if( !isRecoTauChargeFlip_ ){//if genuine same-sign
       //NFSystematicsTTPPQC2Dhisto->Fill(   1, iPdfSys, w );
       //NFSystematicsTTPPQCW12Dhisto->Fill( 1, iPdfSys, 1 );
       //}
       //}
       ...
       */
       ...
       //
       if( AveAbsEtaV3_>=0.9 ) continue; //BARREL
       //if( AveAbsEtaV3_<0.9  ) continue; //ENDCAP
       //
       ...
       if( ST_>410 && LTEMTauPt_>35 ){ //LQM200, 250
	 iLQ++;
	 ...
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>470 && LTEMTauPt_>50 ){ //LQM300
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>490 && LTEMTauPt_>50 ){ //LQM350
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>680 && LTEMTauPt_>65 ){ //LQM400
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       //if( ST_>700 && LTEMTauPt_>70 ){ //LQM450
       if( ST_>700 && LTEMTauPt_>65 ){ //LQM450
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       //if( ST_>770 && LTEMTauPt_>70 ){ //LQM500
       if( ST_>770 && LTEMTauPt_>65 ){ //LQM500
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>800 && LTEMTauPt_>65 ){ //LQM550
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>850 && LTEMTauPt_>65 ){ //LQM600, 650
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
       ...
       //
       if( ST_>850 && LTEMTauPt_>85 ){ //LQM700, 750
	 iLQ++;
	 SystematicsTT2Dhisto->Fill( iLQ, iPdfSys, w );
	 SystematicsTTW12Dhisto->Fill( iLQ, iPdfSys, 1 );
	 if( isRecoMuPrompt_ && isRecoTauPrompt_ ){ //require PP
   ...
   //////////write histos 
   NFSystematicsTT2Dhisto->Write();
   NFSystematicsTTW12Dhisto->Write();
   NFSystematicsTTPP2Dhisto->Write();
   NFSystematicsTTPPW12Dhisto->Write();
   NFSystematicsTTPPQF2Dhisto->Write();
   NFSystematicsTTPPQFW12Dhisto->Write();
   NFSystematicsTTPPQC2Dhisto->Write();
   NFSystematicsTTPPQCW12Dhisto->Write();
   //
