...
void analysisClass::Loop()
{
   ...
   //
   // in TT box..
   TH2D* BarrelFPmatrixhisto      = new TH2D("BarrelFPmatrixhisto",       "BarrelFPmatrixhisto",       10,0.5,10.5, 4,0.5,4.5);
   TH2D* EndcapFPmatrixhisto      = new TH2D("EndcapFPmatrixhisto",       "EndcapFPmatrixhisto",       10,0.5,10.5, 4,0.5,4.5);
   TH2D* BarrelFPmatrixW1histo      = new TH2D("BarrelFPmatrixW1histo",       "BarrelFPmatrixW1histo",       10,0.5,10.5, 4,0.5,4.5);
   TH2D* EndcapFPmatrixW1histo      = new TH2D("EndcapFPmatrixW1histo",       "EndcapFPmatrixW1histo",       10,0.5,10.5, 4,0.5,4.5);
   //
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	 ...
	 passedCut("PassAllMuHLTmatching") && passedCut("PassOfflineCuts") ){ 
       ...
       //if( !isData ) ResetAllSFs_KEEPERROR();// SFs set to 1, keep the SF errors (scaled w.r.t SF if SF>1) for shape based systematic studies!
       //
